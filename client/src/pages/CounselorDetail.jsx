...
const counselors = [
  ...
  },
  {
    ...
    alt: "Narciso",
    description: "Meet Narciso, the web developer with a heart of gold and a knack for creating sites that are both beautiful and functional. He's like a unicorn in the tech world - rare and magical! And now, he's branching out as a camp counselor, bringing his unique blend of creativity and expertise to the great outdoors. Don't be surprised if he designs a website for the campfire songs and s'mores!"
  },
  {
    id: 6,
    name: "Tyler",
...
function CounselorDetail() {
  ...
  return (
    <Container>
      ...
      <h1 className="text-center">Counselors</h1>
